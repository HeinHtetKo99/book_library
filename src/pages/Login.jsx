...
export default function Login() {
  ...
  return (
    <div className="w-full max-w-lg mx-auto my-20">
      <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" onSubmit={signInForm}>
        <div className="mb-4">
        ...
        <div className="flex items-center justify-between">
          <button
            className="bg-primary flex items-center hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
            type="submit"
          >
            {loading && <svg
